...
\begin{figure}[ht]
	\centering
	\includegraphics[width=1.0\linewidth]{img/kiv-dpp-01.png}
\end{figure}
...
\begin{itemize}
	\item GPIO: -
	\item \lang{Zapojení: společná anoda}{Wiring: common anode}, IN - LED - 3.3V
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.3\linewidth]{img/kiv-dpp-01-segments.png}
\end{figure}
